...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    // _price is the price of one LW3Punk
    uint256 public _price= 0.01 ether;

    // _paused to be used to pause the contract just in case
    bool public _paused;
    ...
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "All NFTs are minted");
    ...
    // Function to receive Ether. msg.data mmust be empty
